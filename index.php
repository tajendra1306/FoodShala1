...
<section class="categories">
  <div class="container2">
    ...
    <div class="box-3"><img src="giphy4.gif" class="responsive"><!----->
      <h3 class="float-text text-white">Chinese</h3>
    </div>
    <div class="box-3"><img src="giphy3.gif" class="responsive"><!----->
      <h3 class="float-text text-white">Italian</h3>
    </div>
    <div class="box-3"><img src="giphy2.gif" class="responsive"><!----->
